...
public class RefEx3 {  public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException {
    Class managerClass = Class.forName("org.example._2023_09_05.Manager");

    Constructor constructor = managerClass.getConstructor();
    System.out.println("HAS: " + ((Constructor<?>) constructor).getParameterCount());
    System.out.println("-------------------------------------------");
